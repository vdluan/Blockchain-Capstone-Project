...
/*
    modifier whenNotPaused(){
        require(_paused==true, "It was running!");
        _;
    }

    modifier paused(){
        require(_paused==false, "It was paused!");
        _;
    }
*/
    function SetPaused(bool p) onlyOwner public{
        require(p!=_paused,"Status is the same");
        _paused=p;
        if(_paused)
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to!=_tokenOwner[tokenId],"Approve to current owner");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from==_tokenOwner[tokenId],"Must be the owner of the token");
